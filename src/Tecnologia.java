...
public class Tecnologia extends Producto{
    ...
    public Tecnologia(String tipo, String nombre, double precio, String codigo, int cantidad, String marca, int memoriaRam, String tipoCarga, String tipoRed, int almacenamiento) {
